...
object Enum extends grpc_shaded.scalapb.GeneratedMessageCompanion[grpc_shaded.com.google.protobuf.`type`.Enum] with grpc_shaded.scalapb.JavaProtoSupport[grpc_shaded.com.google.protobuf.`type`.Enum, grpc_shaded.com.google.protobuf.Enum] {
  implicit def messageCompanion: grpc_shaded.scalapb.GeneratedMessageCompanion[grpc_shaded.com.google.protobuf.`type`.Enum] with grpc_shaded.scalapb.JavaProtoSupport[grpc_shaded.com.google.protobuf.`type`.Enum, grpc_shaded.com.google.protobuf.Enum] = this
  def toJavaProto(scalaPbSource: grpc_shaded.com.google.protobuf.`type`.Enum): grpc_shaded.com.google.protobuf.Enum = {
    val javaPbOut = grpc_shaded.com.google.protobuf.Enum.newBuilder
    javaPbOut.setName(scalaPbSource.name)
    javaPbOut.addAllEnumvalue(scalaPbSource.enumvalue.iterator.map(grpc_shaded.com.google.protobuf.`type`.EnumValue.toJavaProto).toIterable.asJava)
  ...
  def fromJavaProto(javaPbSource: grpc_shaded.com.google.protobuf.Enum): grpc_shaded.com.google.protobuf.`type`.Enum = grpc_shaded.com.google.protobuf.`type`.Enum(
    name = javaPbSource.getName,
    enumvalue = javaPbSource.getEnumvalueList.asScala.iterator.map(grpc_shaded.com.google.protobuf.`type`.EnumValue.fromJavaProto).toSeq,
