...
object Syntax extends _root_.grpc_shaded.scalapb.GeneratedEnumCompanion[Syntax] {
  ...
  def fromJavaValue(pbJavaSource: grpc_shaded.com.google.protobuf.Syntax): Syntax = fromValue(pbJavaSource.getNumber)
  def toJavaValue(pbScalaSource: Syntax): grpc_shaded.com.google.protobuf.Syntax = {
    _root_.scala.Predef.require(!pbScalaSource.isUnrecognized, "Unrecognized enum values can not be converted to Java")
    grpc_shaded.com.google.protobuf.Syntax.forNumber(pbScalaSource.value)
  }
}