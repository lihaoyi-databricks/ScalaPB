...
object CodeGeneratorResponse extends grpc_shaded.scalapb.GeneratedMessageCompanion[grpc_shaded.com.google.protobuf.compiler.plugin.CodeGeneratorResponse] with grpc_shaded.scalapb.JavaProtoSupport[grpc_shaded.com.google.protobuf.compiler.plugin.CodeGeneratorResponse, grpc_shaded.com.google.protobuf.compiler.PluginProtos.CodeGeneratorResponse] {
  implicit def messageCompanion: grpc_shaded.scalapb.GeneratedMessageCompanion[grpc_shaded.com.google.protobuf.compiler.plugin.CodeGeneratorResponse] with grpc_shaded.scalapb.JavaProtoSupport[grpc_shaded.com.google.protobuf.compiler.plugin.CodeGeneratorResponse, grpc_shaded.com.google.protobuf.compiler.PluginProtos.CodeGeneratorResponse] = this
  def toJavaProto(scalaPbSource: grpc_shaded.com.google.protobuf.compiler.plugin.CodeGeneratorResponse): grpc_shaded.com.google.protobuf.compiler.PluginProtos.CodeGeneratorResponse = {
    val javaPbOut = grpc_shaded.com.google.protobuf.compiler.PluginProtos.CodeGeneratorResponse.newBuilder
    scalaPbSource.error.foreach(javaPbOut.setError)
    javaPbOut.addAllFile(scalaPbSource.file.iterator.map(grpc_shaded.com.google.protobuf.compiler.plugin.CodeGeneratorResponse.File.toJavaProto).toIterable.asJava)
    javaPbOut.build
  }
  def fromJavaProto(javaPbSource: grpc_shaded.com.google.protobuf.compiler.PluginProtos.CodeGeneratorResponse): grpc_shaded.com.google.protobuf.compiler.plugin.CodeGeneratorResponse = grpc_shaded.com.google.protobuf.compiler.plugin.CodeGeneratorResponse(
    error = if (javaPbSource.hasError) Some(javaPbSource.getError) else _root_.scala.None,
    file = javaPbSource.getFileList.asScala.iterator.map(grpc_shaded.com.google.protobuf.compiler.plugin.CodeGeneratorResponse.File.fromJavaProto).toSeq
  )
  ...
  object File extends grpc_shaded.scalapb.GeneratedMessageCompanion[grpc_shaded.com.google.protobuf.compiler.plugin.CodeGeneratorResponse.File] with grpc_shaded.scalapb.JavaProtoSupport[grpc_shaded.com.google.protobuf.compiler.plugin.CodeGeneratorResponse.File, grpc_shaded.com.google.protobuf.compiler.PluginProtos.CodeGeneratorResponse.File] {
    implicit def messageCompanion: grpc_shaded.scalapb.GeneratedMessageCompanion[grpc_shaded.com.google.protobuf.compiler.plugin.CodeGeneratorResponse.File] with grpc_shaded.scalapb.JavaProtoSupport[grpc_shaded.com.google.protobuf.compiler.plugin.CodeGeneratorResponse.File, grpc_shaded.com.google.protobuf.compiler.PluginProtos.CodeGeneratorResponse.File] = this
    def toJavaProto(scalaPbSource: grpc_shaded.com.google.protobuf.compiler.plugin.CodeGeneratorResponse.File): grpc_shaded.com.google.protobuf.compiler.PluginProtos.CodeGeneratorResponse.File = {
      val javaPbOut = grpc_shaded.com.google.protobuf.compiler.PluginProtos.CodeGeneratorResponse.File.newBuilder
    ...
    def fromJavaProto(javaPbSource: grpc_shaded.com.google.protobuf.compiler.PluginProtos.CodeGeneratorResponse.File): grpc_shaded.com.google.protobuf.compiler.plugin.CodeGeneratorResponse.File = grpc_shaded.com.google.protobuf.compiler.plugin.CodeGeneratorResponse.File(
