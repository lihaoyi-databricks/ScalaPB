...
final case class EnumValueOptions(
    ...
    ) extends grpc_shaded.scalapb.GeneratedMessage with grpc_shaded.scalapb.Message[EnumValueOptions] with grpc_shaded.scalapb.lenses.Updatable[EnumValueOptions] with _root_.grpc_shaded.scalapb.ExtendableMessage[EnumValueOptions] {
    @transient
    ...
    def mergeFrom(`_input__`: _root_.grpc_shaded.com.google.protobuf.CodedInputStream): grpc_shaded.com.google.protobuf.descriptor.EnumValueOptions = {
      ...
      grpc_shaded.com.google.protobuf.descriptor.EnumValueOptions(
    ...
    def addUninterpretedOption(__vs: grpc_shaded.com.google.protobuf.descriptor.UninterpretedOption*): EnumValueOptions = addAllUninterpretedOption(__vs)
    def addAllUninterpretedOption(__vs: Iterable[grpc_shaded.com.google.protobuf.descriptor.UninterpretedOption]): EnumValueOptions = copy(uninterpretedOption = uninterpretedOption ++ __vs)
    def withUninterpretedOption(__v: _root_.scala.Seq[grpc_shaded.com.google.protobuf.descriptor.UninterpretedOption]): EnumValueOptions = copy(uninterpretedOption = __v)
    ...
    def getField(__field: _root_.grpc_shaded.scalapb.descriptors.FieldDescriptor): _root_.grpc_shaded.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        case 1 => deprecated.map(_root_.grpc_shaded.scalapb.descriptors.PBoolean).getOrElse(_root_.grpc_shaded.scalapb.descriptors.PEmpty)
    ...
    def companion = grpc_shaded.com.google.protobuf.descriptor.EnumValueOptions
}

object EnumValueOptions extends grpc_shaded.scalapb.GeneratedMessageCompanion[grpc_shaded.com.google.protobuf.descriptor.EnumValueOptions] with grpc_shaded.scalapb.JavaProtoSupport[grpc_shaded.com.google.protobuf.descriptor.EnumValueOptions, grpc_shaded.com.google.protobuf.DescriptorProtos.EnumValueOptions] {
  implicit def messageCompanion: grpc_shaded.scalapb.GeneratedMessageCompanion[grpc_shaded.com.google.protobuf.descriptor.EnumValueOptions] with grpc_shaded.scalapb.JavaProtoSupport[grpc_shaded.com.google.protobuf.descriptor.EnumValueOptions, grpc_shaded.com.google.protobuf.DescriptorProtos.EnumValueOptions] = this
  def toJavaProto(scalaPbSource: grpc_shaded.com.google.protobuf.descriptor.EnumValueOptions): grpc_shaded.com.google.protobuf.DescriptorProtos.EnumValueOptions = {
    val javaPbOut = grpc_shaded.com.google.protobuf.DescriptorProtos.EnumValueOptions.newBuilder
  ...
  def fromJavaProto(javaPbSource: grpc_shaded.com.google.protobuf.DescriptorProtos.EnumValueOptions): grpc_shaded.com.google.protobuf.descriptor.EnumValueOptions = grpc_shaded.com.google.protobuf.descriptor.EnumValueOptions(
  ...
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.grpc_shaded.com.google.protobuf.Descriptors.FieldDescriptor, _root_.scala.Any]): grpc_shaded.com.google.protobuf.descriptor.EnumValueOptions = {
  ...
  implicit def messageReads: _root_.grpc_shaded.scalapb.descriptors.Reads[grpc_shaded.com.google.protobuf.descriptor.EnumValueOptions] = _root_.grpc_shaded.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.grpc_shaded.com.google.protobuf.Descriptors.Descriptor = DescriptorProtoCompanion.javaDescriptor.getMessageTypes.get(15)
  def scalaDescriptor: _root_.grpc_shaded.scalapb.descriptors.Descriptor = DescriptorProtoCompanion.scalaDescriptor.messages(15)
  ...
  lazy val defaultInstance = grpc_shaded.com.google.protobuf.descriptor.EnumValueOptions(
  )
  implicit class EnumValueOptionsLens[UpperPB](_l: _root_.grpc_shaded.scalapb.lenses.Lens[UpperPB, grpc_shaded.com.google.protobuf.descriptor.EnumValueOptions]) extends _root_.grpc_shaded.scalapb.lenses.ObjectLens[UpperPB, grpc_shaded.com.google.protobuf.descriptor.EnumValueOptions](_l) {
  ...
  ): _root_.grpc_shaded.com.google.protobuf.descriptor.EnumValueOptions = _root_.grpc_shaded.com.google.protobuf.descriptor.EnumValueOptions(
    deprecated,
    uninterpretedOption,
    unknownFields
  )
