...
final case class MethodOptions(
    ...
    ) extends shaded.scalapb.GeneratedMessage with shaded.scalapb.Message[MethodOptions] with shaded.scalapb.lenses.Updatable[MethodOptions] with _root_.shaded.scalapb.ExtendableMessage[MethodOptions] {
    @transient
    ...
    def getField(__field: _root_.shaded.scalapb.descriptors.FieldDescriptor): _root_.shaded.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        ...
        case 34 => idempotencyLevel.map(__e => _root_.shaded.scalapb.descriptors.PEnum(__e.scalaValueDescriptor)).getOrElse(_root_.shaded.scalapb.descriptors.PEmpty)
...
object MethodOptions extends shaded.scalapb.GeneratedMessageCompanion[com.google.protobuf.descriptor.MethodOptions] with shaded.scalapb.JavaProtoSupport[com.google.protobuf.descriptor.MethodOptions, com.google.protobuf.DescriptorProtos.MethodOptions] {
  implicit def messageCompanion: shaded.scalapb.GeneratedMessageCompanion[com.google.protobuf.descriptor.MethodOptions] with shaded.scalapb.JavaProtoSupport[com.google.protobuf.descriptor.MethodOptions, com.google.protobuf.DescriptorProtos.MethodOptions] = this
  ...
  implicit def messageReads: _root_.shaded.scalapb.descriptors.Reads[com.google.protobuf.descriptor.MethodOptions] = _root_.shaded.scalapb.descriptors.Reads{
    case _root_.shaded.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      com.google.protobuf.descriptor.MethodOptions(
        ...
        __fieldsMap.get(scalaDescriptor.findFieldByNumber(34).get).flatMap(_.as[_root_.scala.Option[_root_.shaded.scalapb.descriptors.EnumValueDescriptor]]).map(__e => com.google.protobuf.descriptor.MethodOptions.IdempotencyLevel.fromValue(__e.number)),
  ...
  def scalaDescriptor: _root_.shaded.scalapb.descriptors.Descriptor = DescriptorProtoCompanion.scalaDescriptor.messages(17)
  ...
  /** Is this method side-effect-free (or safe in HTTP parlance), or idempotent,
    ...
    */
  sealed trait IdempotencyLevel extends _root_.shaded.scalapb.GeneratedEnum {
    ...
    def companion: _root_.shaded.scalapb.GeneratedEnumCompanion[IdempotencyLevel] = com.google.protobuf.descriptor.MethodOptions.IdempotencyLevel
  }
  
  object IdempotencyLevel extends _root_.shaded.scalapb.GeneratedEnumCompanion[IdempotencyLevel] {
    implicit def enumCompanion: _root_.shaded.scalapb.GeneratedEnumCompanion[IdempotencyLevel] = this
    @SerialVersionUID(0L)
    ...
    @SerialVersionUID(0L)
    final case class Unrecognized(value: _root_.scala.Int) extends IdempotencyLevel with _root_.shaded.scalapb.UnrecognizedEnum
    ...
    def scalaDescriptor: _root_.shaded.scalapb.descriptors.EnumDescriptor = com.google.protobuf.descriptor.MethodOptions.scalaDescriptor.enums(0)
  ...
  implicit class MethodOptionsLens[UpperPB](_l: _root_.shaded.scalapb.lenses.Lens[UpperPB, com.google.protobuf.descriptor.MethodOptions]) extends _root_.shaded.scalapb.lenses.ObjectLens[UpperPB, com.google.protobuf.descriptor.MethodOptions](_l) {
    ...
    def idempotencyLevel: _root_.shaded.scalapb.lenses.Lens[UpperPB, com.google.protobuf.descriptor.MethodOptions.IdempotencyLevel] = field(_.getIdempotencyLevel)((c_, f_) => c_.copy(idempotencyLevel = Option(f_)))
    def optionalIdempotencyLevel: _root_.shaded.scalapb.lenses.Lens[UpperPB, _root_.scala.Option[com.google.protobuf.descriptor.MethodOptions.IdempotencyLevel]] = field(_.idempotencyLevel)((c_, f_) => c_.copy(idempotencyLevel = f_))
