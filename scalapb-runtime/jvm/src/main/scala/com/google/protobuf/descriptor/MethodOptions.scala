...
object MethodOptions extends grpc_shaded.scalapb.GeneratedMessageCompanion[grpc_shaded.com.google.protobuf.descriptor.MethodOptions] with grpc_shaded.scalapb.JavaProtoSupport[grpc_shaded.com.google.protobuf.descriptor.MethodOptions, grpc_shaded.com.google.protobuf.DescriptorProtos.MethodOptions] {
  implicit def messageCompanion: grpc_shaded.scalapb.GeneratedMessageCompanion[grpc_shaded.com.google.protobuf.descriptor.MethodOptions] with grpc_shaded.scalapb.JavaProtoSupport[grpc_shaded.com.google.protobuf.descriptor.MethodOptions, grpc_shaded.com.google.protobuf.DescriptorProtos.MethodOptions] = this
  def toJavaProto(scalaPbSource: grpc_shaded.com.google.protobuf.descriptor.MethodOptions): grpc_shaded.com.google.protobuf.DescriptorProtos.MethodOptions = {
    val javaPbOut = grpc_shaded.com.google.protobuf.DescriptorProtos.MethodOptions.newBuilder
    scalaPbSource.deprecated.foreach(javaPbOut.setDeprecated)
    scalaPbSource.idempotencyLevel.map(grpc_shaded.com.google.protobuf.descriptor.MethodOptions.IdempotencyLevel.toJavaValue).foreach(javaPbOut.setIdempotencyLevel)
  ...
  def fromJavaProto(javaPbSource: grpc_shaded.com.google.protobuf.DescriptorProtos.MethodOptions): grpc_shaded.com.google.protobuf.descriptor.MethodOptions = grpc_shaded.com.google.protobuf.descriptor.MethodOptions(
    deprecated = if (javaPbSource.hasDeprecated) Some(javaPbSource.getDeprecated.booleanValue) else _root_.scala.None,
    idempotencyLevel = if (javaPbSource.hasIdempotencyLevel) Some(grpc_shaded.com.google.protobuf.descriptor.MethodOptions.IdempotencyLevel.fromJavaValue(javaPbSource.getIdempotencyLevel)) else _root_.scala.None,
  ...
  object IdempotencyLevel extends _root_.grpc_shaded.scalapb.GeneratedEnumCompanion[IdempotencyLevel] {
    ...
    def fromJavaValue(pbJavaSource: grpc_shaded.com.google.protobuf.DescriptorProtos.MethodOptions.IdempotencyLevel): IdempotencyLevel = fromValue(pbJavaSource.getNumber)
    def toJavaValue(pbScalaSource: IdempotencyLevel): grpc_shaded.com.google.protobuf.DescriptorProtos.MethodOptions.IdempotencyLevel = {
      _root_.scala.Predef.require(!pbScalaSource.isUnrecognized, "Unrecognized enum values can not be converted to Java")
      grpc_shaded.com.google.protobuf.DescriptorProtos.MethodOptions.IdempotencyLevel.forNumber(pbScalaSource.value)
    }
  }
