...
final case class EnumOptions(
    ...
    ) extends grpc_shaded.scalapb.GeneratedMessage with grpc_shaded.scalapb.Message[EnumOptions] with grpc_shaded.scalapb.lenses.Updatable[EnumOptions] with _root_.grpc_shaded.scalapb.ExtendableMessage[EnumOptions] {
    @transient
    ...
    def mergeFrom(`_input__`: _root_.grpc_shaded.com.google.protobuf.CodedInputStream): grpc_shaded.com.google.protobuf.descriptor.EnumOptions = {
      ...
      grpc_shaded.com.google.protobuf.descriptor.EnumOptions(
    ...
    def addUninterpretedOption(__vs: grpc_shaded.com.google.protobuf.descriptor.UninterpretedOption*): EnumOptions = addAllUninterpretedOption(__vs)
    def addAllUninterpretedOption(__vs: Iterable[grpc_shaded.com.google.protobuf.descriptor.UninterpretedOption]): EnumOptions = copy(uninterpretedOption = uninterpretedOption ++ __vs)
    def withUninterpretedOption(__v: _root_.scala.Seq[grpc_shaded.com.google.protobuf.descriptor.UninterpretedOption]): EnumOptions = copy(uninterpretedOption = __v)
    ...
    def getField(__field: _root_.grpc_shaded.scalapb.descriptors.FieldDescriptor): _root_.grpc_shaded.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        case 2 => allowAlias.map(_root_.grpc_shaded.scalapb.descriptors.PBoolean).getOrElse(_root_.grpc_shaded.scalapb.descriptors.PEmpty)
    ...
    def companion = grpc_shaded.com.google.protobuf.descriptor.EnumOptions
}

object EnumOptions extends grpc_shaded.scalapb.GeneratedMessageCompanion[grpc_shaded.com.google.protobuf.descriptor.EnumOptions] with grpc_shaded.scalapb.JavaProtoSupport[grpc_shaded.com.google.protobuf.descriptor.EnumOptions, grpc_shaded.com.google.protobuf.DescriptorProtos.EnumOptions] {
  implicit def messageCompanion: grpc_shaded.scalapb.GeneratedMessageCompanion[grpc_shaded.com.google.protobuf.descriptor.EnumOptions] with grpc_shaded.scalapb.JavaProtoSupport[grpc_shaded.com.google.protobuf.descriptor.EnumOptions, grpc_shaded.com.google.protobuf.DescriptorProtos.EnumOptions] = this
  def toJavaProto(scalaPbSource: grpc_shaded.com.google.protobuf.descriptor.EnumOptions): grpc_shaded.com.google.protobuf.DescriptorProtos.EnumOptions = {
    val javaPbOut = grpc_shaded.com.google.protobuf.DescriptorProtos.EnumOptions.newBuilder
  ...
  def fromJavaProto(javaPbSource: grpc_shaded.com.google.protobuf.DescriptorProtos.EnumOptions): grpc_shaded.com.google.protobuf.descriptor.EnumOptions = grpc_shaded.com.google.protobuf.descriptor.EnumOptions(
  ...
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.grpc_shaded.com.google.protobuf.Descriptors.FieldDescriptor, _root_.scala.Any]): grpc_shaded.com.google.protobuf.descriptor.EnumOptions = {
  ...
  implicit def messageReads: _root_.grpc_shaded.scalapb.descriptors.Reads[grpc_shaded.com.google.protobuf.descriptor.EnumOptions] = _root_.grpc_shaded.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.grpc_shaded.com.google.protobuf.Descriptors.Descriptor = DescriptorProtoCompanion.javaDescriptor.getMessageTypes.get(14)
  def scalaDescriptor: _root_.grpc_shaded.scalapb.descriptors.Descriptor = DescriptorProtoCompanion.scalaDescriptor.messages(14)
  ...
  lazy val defaultInstance = grpc_shaded.com.google.protobuf.descriptor.EnumOptions(
  )
  implicit class EnumOptionsLens[UpperPB](_l: _root_.grpc_shaded.scalapb.lenses.Lens[UpperPB, grpc_shaded.com.google.protobuf.descriptor.EnumOptions]) extends _root_.grpc_shaded.scalapb.lenses.ObjectLens[UpperPB, grpc_shaded.com.google.protobuf.descriptor.EnumOptions](_l) {
    def allowAlias: _root_.grpc_shaded.scalapb.lenses.Lens[UpperPB, _root_.scala.Boolean] = field(_.getAllowAlias)((c_, f_) => c_.copy(allowAlias = Option(f_)))
    def optionalAllowAlias: _root_.grpc_shaded.scalapb.lenses.Lens[UpperPB, _root_.scala.Option[_root_.scala.Boolean]] = field(_.allowAlias)((c_, f_) => c_.copy(allowAlias = f_))
  ...
  ): _root_.grpc_shaded.com.google.protobuf.descriptor.EnumOptions = _root_.grpc_shaded.com.google.protobuf.descriptor.EnumOptions(
    allowAlias,
    deprecated,
    uninterpretedOption,
    unknownFields
