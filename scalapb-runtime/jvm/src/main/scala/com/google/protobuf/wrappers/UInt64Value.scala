...
final case class UInt64Value(
    ...
    ) extends shaded.scalapb.GeneratedMessage with shaded.scalapb.Message[UInt64Value] with shaded.scalapb.lenses.Updatable[UInt64Value] {
    @transient
    ...
    def getField(__field: _root_.shaded.scalapb.descriptors.FieldDescriptor): _root_.shaded.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        case 1 => _root_.shaded.scalapb.descriptors.PLong(value)
      }
    }
...
object UInt64Value extends shaded.scalapb.GeneratedMessageCompanion[com.google.protobuf.wrappers.UInt64Value] with shaded.scalapb.JavaProtoSupport[com.google.protobuf.wrappers.UInt64Value, com.google.protobuf.UInt64Value] {
  implicit def messageCompanion: shaded.scalapb.GeneratedMessageCompanion[com.google.protobuf.wrappers.UInt64Value] with shaded.scalapb.JavaProtoSupport[com.google.protobuf.wrappers.UInt64Value, com.google.protobuf.UInt64Value] = this
  ...
  implicit def messageReads: _root_.shaded.scalapb.descriptors.Reads[com.google.protobuf.wrappers.UInt64Value] = _root_.shaded.scalapb.descriptors.Reads{
  ...
  def scalaDescriptor: _root_.shaded.scalapb.descriptors.Descriptor = WrappersProto.scalaDescriptor.messages(3)
  ...
  implicit class UInt64ValueLens[UpperPB](_l: _root_.shaded.scalapb.lenses.Lens[UpperPB, com.google.protobuf.wrappers.UInt64Value]) extends _root_.shaded.scalapb.lenses.ObjectLens[UpperPB, com.google.protobuf.wrappers.UInt64Value](_l) {
    def value: _root_.shaded.scalapb.lenses.Lens[UpperPB, _root_.scala.Long] = field(_.value)((c_, f_) => c_.copy(value = f_))
  }
