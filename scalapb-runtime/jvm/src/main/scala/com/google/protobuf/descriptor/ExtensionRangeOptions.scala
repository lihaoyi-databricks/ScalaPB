...
final case class ExtensionRangeOptions(
    ...
    ) extends grpc_shaded.scalapb.GeneratedMessage with grpc_shaded.scalapb.Message[ExtensionRangeOptions] with grpc_shaded.scalapb.lenses.Updatable[ExtensionRangeOptions] with _root_.grpc_shaded.scalapb.ExtendableMessage[ExtensionRangeOptions] {
    @transient
    ...
    def mergeFrom(`_input__`: _root_.grpc_shaded.com.google.protobuf.CodedInputStream): grpc_shaded.com.google.protobuf.descriptor.ExtensionRangeOptions = {
      ...
      grpc_shaded.com.google.protobuf.descriptor.ExtensionRangeOptions(
    ...
    def addUninterpretedOption(__vs: grpc_shaded.com.google.protobuf.descriptor.UninterpretedOption*): ExtensionRangeOptions = addAllUninterpretedOption(__vs)
    def addAllUninterpretedOption(__vs: Iterable[grpc_shaded.com.google.protobuf.descriptor.UninterpretedOption]): ExtensionRangeOptions = copy(uninterpretedOption = uninterpretedOption ++ __vs)
    def withUninterpretedOption(__v: _root_.scala.Seq[grpc_shaded.com.google.protobuf.descriptor.UninterpretedOption]): ExtensionRangeOptions = copy(uninterpretedOption = __v)
    ...
    def companion = grpc_shaded.com.google.protobuf.descriptor.ExtensionRangeOptions
}

object ExtensionRangeOptions extends grpc_shaded.scalapb.GeneratedMessageCompanion[grpc_shaded.com.google.protobuf.descriptor.ExtensionRangeOptions] with grpc_shaded.scalapb.JavaProtoSupport[grpc_shaded.com.google.protobuf.descriptor.ExtensionRangeOptions, grpc_shaded.com.google.protobuf.DescriptorProtos.ExtensionRangeOptions] {
  implicit def messageCompanion: grpc_shaded.scalapb.GeneratedMessageCompanion[grpc_shaded.com.google.protobuf.descriptor.ExtensionRangeOptions] with grpc_shaded.scalapb.JavaProtoSupport[grpc_shaded.com.google.protobuf.descriptor.ExtensionRangeOptions, grpc_shaded.com.google.protobuf.DescriptorProtos.ExtensionRangeOptions] = this
  def toJavaProto(scalaPbSource: grpc_shaded.com.google.protobuf.descriptor.ExtensionRangeOptions): grpc_shaded.com.google.protobuf.DescriptorProtos.ExtensionRangeOptions = {
    val javaPbOut = grpc_shaded.com.google.protobuf.DescriptorProtos.ExtensionRangeOptions.newBuilder
  ...
  def fromJavaProto(javaPbSource: grpc_shaded.com.google.protobuf.DescriptorProtos.ExtensionRangeOptions): grpc_shaded.com.google.protobuf.descriptor.ExtensionRangeOptions = grpc_shaded.com.google.protobuf.descriptor.ExtensionRangeOptions(
  ...
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.grpc_shaded.com.google.protobuf.Descriptors.FieldDescriptor, _root_.scala.Any]): grpc_shaded.com.google.protobuf.descriptor.ExtensionRangeOptions = {
  ...
  implicit def messageReads: _root_.grpc_shaded.scalapb.descriptors.Reads[grpc_shaded.com.google.protobuf.descriptor.ExtensionRangeOptions] = _root_.grpc_shaded.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.grpc_shaded.com.google.protobuf.Descriptors.Descriptor = DescriptorProtoCompanion.javaDescriptor.getMessageTypes.get(3)
  def scalaDescriptor: _root_.grpc_shaded.scalapb.descriptors.Descriptor = DescriptorProtoCompanion.scalaDescriptor.messages(3)
  ...
  lazy val defaultInstance = grpc_shaded.com.google.protobuf.descriptor.ExtensionRangeOptions(
  )
  implicit class ExtensionRangeOptionsLens[UpperPB](_l: _root_.grpc_shaded.scalapb.lenses.Lens[UpperPB, grpc_shaded.com.google.protobuf.descriptor.ExtensionRangeOptions]) extends _root_.grpc_shaded.scalapb.lenses.ObjectLens[UpperPB, grpc_shaded.com.google.protobuf.descriptor.ExtensionRangeOptions](_l) {
  ...
  ): _root_.grpc_shaded.com.google.protobuf.descriptor.ExtensionRangeOptions = _root_.grpc_shaded.com.google.protobuf.descriptor.ExtensionRangeOptions(
    uninterpretedOption,
    unknownFields
  )
}
