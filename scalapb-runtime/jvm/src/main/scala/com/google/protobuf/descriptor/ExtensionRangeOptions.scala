...
final case class ExtensionRangeOptions(
    ...
    ) extends shaded.scalapb.GeneratedMessage with shaded.scalapb.Message[ExtensionRangeOptions] with shaded.scalapb.lenses.Updatable[ExtensionRangeOptions] with _root_.shaded.scalapb.ExtendableMessage[ExtensionRangeOptions] {
    @transient
...
object ExtensionRangeOptions extends shaded.scalapb.GeneratedMessageCompanion[com.google.protobuf.descriptor.ExtensionRangeOptions] with shaded.scalapb.JavaProtoSupport[com.google.protobuf.descriptor.ExtensionRangeOptions, com.google.protobuf.DescriptorProtos.ExtensionRangeOptions] {
  implicit def messageCompanion: shaded.scalapb.GeneratedMessageCompanion[com.google.protobuf.descriptor.ExtensionRangeOptions] with shaded.scalapb.JavaProtoSupport[com.google.protobuf.descriptor.ExtensionRangeOptions, com.google.protobuf.DescriptorProtos.ExtensionRangeOptions] = this
  ...
  implicit def messageReads: _root_.shaded.scalapb.descriptors.Reads[com.google.protobuf.descriptor.ExtensionRangeOptions] = _root_.shaded.scalapb.descriptors.Reads{
  ...
  def scalaDescriptor: _root_.shaded.scalapb.descriptors.Descriptor = DescriptorProtoCompanion.scalaDescriptor.messages(3)
  ...
  implicit class ExtensionRangeOptionsLens[UpperPB](_l: _root_.shaded.scalapb.lenses.Lens[UpperPB, com.google.protobuf.descriptor.ExtensionRangeOptions]) extends _root_.shaded.scalapb.lenses.ObjectLens[UpperPB, com.google.protobuf.descriptor.ExtensionRangeOptions](_l) {
