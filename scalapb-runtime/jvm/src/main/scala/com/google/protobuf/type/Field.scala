...
object Field extends grpc_shaded.scalapb.GeneratedMessageCompanion[grpc_shaded.com.google.protobuf.`type`.Field] with grpc_shaded.scalapb.JavaProtoSupport[grpc_shaded.com.google.protobuf.`type`.Field, grpc_shaded.com.google.protobuf.Field] {
  implicit def messageCompanion: grpc_shaded.scalapb.GeneratedMessageCompanion[grpc_shaded.com.google.protobuf.`type`.Field] with grpc_shaded.scalapb.JavaProtoSupport[grpc_shaded.com.google.protobuf.`type`.Field, grpc_shaded.com.google.protobuf.Field] = this
  def toJavaProto(scalaPbSource: grpc_shaded.com.google.protobuf.`type`.Field): grpc_shaded.com.google.protobuf.Field = {
    val javaPbOut = grpc_shaded.com.google.protobuf.Field.newBuilder
  ...
  def fromJavaProto(javaPbSource: grpc_shaded.com.google.protobuf.Field): grpc_shaded.com.google.protobuf.`type`.Field = grpc_shaded.com.google.protobuf.`type`.Field(
    kind = grpc_shaded.com.google.protobuf.`type`.Field.Kind.fromValue(javaPbSource.getKindValue.intValue),
    cardinality = grpc_shaded.com.google.protobuf.`type`.Field.Cardinality.fromValue(javaPbSource.getCardinalityValue.intValue),
  ...
  object Kind extends _root_.grpc_shaded.scalapb.GeneratedEnumCompanion[Kind] {
    ...
    def fromJavaValue(pbJavaSource: grpc_shaded.com.google.protobuf.Field.Kind): Kind = fromValue(pbJavaSource.getNumber)
    def toJavaValue(pbScalaSource: Kind): grpc_shaded.com.google.protobuf.Field.Kind = {
      _root_.scala.Predef.require(!pbScalaSource.isUnrecognized, "Unrecognized enum values can not be converted to Java")
      grpc_shaded.com.google.protobuf.Field.Kind.forNumber(pbScalaSource.value)
    }
  }
  ...
  object Cardinality extends _root_.grpc_shaded.scalapb.GeneratedEnumCompanion[Cardinality] {
    ...
    def fromJavaValue(pbJavaSource: grpc_shaded.com.google.protobuf.Field.Cardinality): Cardinality = fromValue(pbJavaSource.getNumber)
    def toJavaValue(pbScalaSource: Cardinality): grpc_shaded.com.google.protobuf.Field.Cardinality = {
      _root_.scala.Predef.require(!pbScalaSource.isUnrecognized, "Unrecognized enum values can not be converted to Java")
      grpc_shaded.com.google.protobuf.Field.Cardinality.forNumber(pbScalaSource.value)
    }
  }
