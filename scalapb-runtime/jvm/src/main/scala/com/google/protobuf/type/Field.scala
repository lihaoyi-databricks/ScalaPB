...
object Field extends shaded.scalapb.GeneratedMessageCompanion[com.google.protobuf.`type`.Field] with shaded.scalapb.JavaProtoSupport[com.google.protobuf.`type`.Field, com.google.protobuf.Field] {
  implicit def messageCompanion: shaded.scalapb.GeneratedMessageCompanion[com.google.protobuf.`type`.Field] with shaded.scalapb.JavaProtoSupport[com.google.protobuf.`type`.Field, com.google.protobuf.Field] = this
