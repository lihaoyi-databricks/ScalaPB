...
final case class Int32Value(
    ...
    ) extends shaded.scalapb.GeneratedMessage with shaded.scalapb.Message[Int32Value] with shaded.scalapb.lenses.Updatable[Int32Value] {
    @transient
...
object Int32Value extends shaded.scalapb.GeneratedMessageCompanion[com.google.protobuf.wrappers.Int32Value] with shaded.scalapb.JavaProtoSupport[com.google.protobuf.wrappers.Int32Value, com.google.protobuf.Int32Value] {
  implicit def messageCompanion: shaded.scalapb.GeneratedMessageCompanion[com.google.protobuf.wrappers.Int32Value] with shaded.scalapb.JavaProtoSupport[com.google.protobuf.wrappers.Int32Value, com.google.protobuf.Int32Value] = this
  ...
  implicit def messageReads: _root_.shaded.scalapb.descriptors.Reads[com.google.protobuf.wrappers.Int32Value] = _root_.shaded.scalapb.descriptors.Reads{
  ...
  def scalaDescriptor: _root_.shaded.scalapb.descriptors.Descriptor = WrappersProto.scalaDescriptor.messages(4)
  ...
  implicit class Int32ValueLens[UpperPB](_l: _root_.shaded.scalapb.lenses.Lens[UpperPB, com.google.protobuf.wrappers.Int32Value]) extends _root_.shaded.scalapb.lenses.ObjectLens[UpperPB, com.google.protobuf.wrappers.Int32Value](_l) {
