...
object Duration extends grpc_shaded.scalapb.GeneratedMessageCompanion[grpc_shaded.com.google.protobuf.duration.Duration] with grpc_shaded.scalapb.JavaProtoSupport[grpc_shaded.com.google.protobuf.duration.Duration, grpc_shaded.com.google.protobuf.Duration] {
  implicit def messageCompanion: grpc_shaded.scalapb.GeneratedMessageCompanion[grpc_shaded.com.google.protobuf.duration.Duration] with grpc_shaded.scalapb.JavaProtoSupport[grpc_shaded.com.google.protobuf.duration.Duration, grpc_shaded.com.google.protobuf.Duration] = this
  def toJavaProto(scalaPbSource: grpc_shaded.com.google.protobuf.duration.Duration): grpc_shaded.com.google.protobuf.Duration = {
    val javaPbOut = grpc_shaded.com.google.protobuf.Duration.newBuilder
    javaPbOut.setSeconds(scalaPbSource.seconds)
    javaPbOut.setNanos(scalaPbSource.nanos)
    javaPbOut.build
  }
  def fromJavaProto(javaPbSource: grpc_shaded.com.google.protobuf.Duration): grpc_shaded.com.google.protobuf.duration.Duration = grpc_shaded.com.google.protobuf.duration.Duration(
