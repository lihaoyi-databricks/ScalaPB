...
final case class Mixin(
    ...
    ) extends shaded.scalapb.GeneratedMessage with shaded.scalapb.Message[Mixin] with shaded.scalapb.lenses.Updatable[Mixin] {
    @transient
    ...
    def getField(__field: _root_.shaded.scalapb.descriptors.FieldDescriptor): _root_.shaded.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        ...
        case 2 => _root_.shaded.scalapb.descriptors.PString(root)
      }
    }
...
object Mixin extends shaded.scalapb.GeneratedMessageCompanion[com.google.protobuf.api.Mixin] with shaded.scalapb.JavaProtoSupport[com.google.protobuf.api.Mixin, com.google.protobuf.Mixin] {
  implicit def messageCompanion: shaded.scalapb.GeneratedMessageCompanion[com.google.protobuf.api.Mixin] with shaded.scalapb.JavaProtoSupport[com.google.protobuf.api.Mixin, com.google.protobuf.Mixin] = this
  ...
  implicit def messageReads: _root_.shaded.scalapb.descriptors.Reads[com.google.protobuf.api.Mixin] = _root_.shaded.scalapb.descriptors.Reads{
  ...
  def scalaDescriptor: _root_.shaded.scalapb.descriptors.Descriptor = ApiProto.scalaDescriptor.messages(2)
  ...
  implicit class MixinLens[UpperPB](_l: _root_.shaded.scalapb.lenses.Lens[UpperPB, com.google.protobuf.api.Mixin]) extends _root_.shaded.scalapb.lenses.ObjectLens[UpperPB, com.google.protobuf.api.Mixin](_l) {
    def name: _root_.shaded.scalapb.lenses.Lens[UpperPB, _root_.scala.Predef.String] = field(_.name)((c_, f_) => c_.copy(name = f_))
    def root: _root_.shaded.scalapb.lenses.Lens[UpperPB, _root_.scala.Predef.String] = field(_.root)((c_, f_) => c_.copy(root = f_))
  }
