...
object Type extends grpc_shaded.scalapb.GeneratedMessageCompanion[grpc_shaded.com.google.protobuf.`type`.Type] with grpc_shaded.scalapb.JavaProtoSupport[grpc_shaded.com.google.protobuf.`type`.Type, grpc_shaded.com.google.protobuf.Type] {
  implicit def messageCompanion: grpc_shaded.scalapb.GeneratedMessageCompanion[grpc_shaded.com.google.protobuf.`type`.Type] with grpc_shaded.scalapb.JavaProtoSupport[grpc_shaded.com.google.protobuf.`type`.Type, grpc_shaded.com.google.protobuf.Type] = this
  def toJavaProto(scalaPbSource: grpc_shaded.com.google.protobuf.`type`.Type): grpc_shaded.com.google.protobuf.Type = {
    val javaPbOut = grpc_shaded.com.google.protobuf.Type.newBuilder
    javaPbOut.setName(scalaPbSource.name)
    javaPbOut.addAllFields(scalaPbSource.fields.iterator.map(grpc_shaded.com.google.protobuf.`type`.Field.toJavaProto).toIterable.asJava)
  ...
  def fromJavaProto(javaPbSource: grpc_shaded.com.google.protobuf.Type): grpc_shaded.com.google.protobuf.`type`.Type = grpc_shaded.com.google.protobuf.`type`.Type(
    name = javaPbSource.getName,
    fields = javaPbSource.getFieldsList.asScala.iterator.map(grpc_shaded.com.google.protobuf.`type`.Field.fromJavaProto).toSeq,
