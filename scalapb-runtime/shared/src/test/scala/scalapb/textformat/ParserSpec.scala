        ...
        TMessage(
          ...
          Seq(
            ...
            TField(
              17,
              "bal",
              TArray(22, Seq(TIntLiteral(23, 3), TIntLiteral(26, 4), TIntLiteral(29, 5)))
            ),
      ...
      check(
        ...
        TMessage(
          ...
          Seq(
                ...
                Seq(
                  TField(
                    ...
                    TMessage(
                      10,
                      Seq(
                        TField(16, "brr", TMessage(20, Seq(TField(28, "eee", TMessage(32, Seq())))))
                      )
                    )
                  ),
            ...
            TField(66, "wa", TMessage(69, Seq(TField(73, "njp", TLiteral(78, "-3.90173722E9")))))
          )
        )
      )
    }
