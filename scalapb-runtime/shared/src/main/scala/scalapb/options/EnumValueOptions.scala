...
object EnumValueOptions extends scalapb.GeneratedMessageCompanion[scalapb.options.EnumValueOptions] {
  ...
  implicit def messageReads: _root_.shaded.scalapb.descriptors.Reads[scalapb.options.EnumValueOptions] = _root_.shaded.scalapb.descriptors.Reads{
  ...
  def scalaDescriptor: _root_.shaded.scalapb.descriptors.Descriptor = ScalapbProto.scalaDescriptor.messages(4)
  ...
  implicit class EnumValueOptionsLens[UpperPB](_l: _root_.shaded.scalapb.lenses.Lens[UpperPB, scalapb.options.EnumValueOptions]) extends _root_.shaded.scalapb.lenses.ObjectLens[UpperPB, scalapb.options.EnumValueOptions](_l) {
  ...
  ): _root_.shaded.scalapb.options.EnumValueOptions = _root_.shaded.scalapb.options.EnumValueOptions(
    `extends`
  )
}
