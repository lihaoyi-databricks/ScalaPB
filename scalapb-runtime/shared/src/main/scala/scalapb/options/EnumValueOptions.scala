...
final case class EnumValueOptions(
    ...
    def mergeFrom(`_input__`: _root_.grpc_shaded.com.google.protobuf.CodedInputStream): scalapb.options.EnumValueOptions = {
...
object EnumValueOptions extends scalapb.GeneratedMessageCompanion[scalapb.options.EnumValueOptions] {
  ...
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.grpc_shaded.com.google.protobuf.Descriptors.FieldDescriptor, _root_.scala.Any]): scalapb.options.EnumValueOptions = {
  ...
  implicit def messageReads: _root_.grpc_shaded.scalapb.descriptors.Reads[scalapb.options.EnumValueOptions] = _root_.grpc_shaded.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.grpc_shaded.com.google.protobuf.Descriptors.Descriptor = ScalapbProto.javaDescriptor.getMessageTypes.get(4)
  def scalaDescriptor: _root_.grpc_shaded.scalapb.descriptors.Descriptor = ScalapbProto.scalaDescriptor.messages(4)
  ...
  implicit class EnumValueOptionsLens[UpperPB](_l: _root_.grpc_shaded.scalapb.lenses.Lens[UpperPB, scalapb.options.EnumValueOptions]) extends _root_.grpc_shaded.scalapb.lenses.ObjectLens[UpperPB, scalapb.options.EnumValueOptions](_l) {
  ...
  ): _root_.grpc_shaded.scalapb.options.EnumValueOptions = _root_.grpc_shaded.scalapb.options.EnumValueOptions(
    `extends`
  )
}
