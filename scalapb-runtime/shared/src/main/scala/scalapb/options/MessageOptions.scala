...
final case class MessageOptions(
    ...
    def getField(__field: _root_.shaded.scalapb.descriptors.FieldDescriptor): _root_.shaded.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        case 1 => _root_.shaded.scalapb.descriptors.PRepeated(`extends`.iterator.map(_root_.shaded.scalapb.descriptors.PString).toVector)
        case 2 => _root_.shaded.scalapb.descriptors.PRepeated(companionExtends.iterator.map(_root_.shaded.scalapb.descriptors.PString).toVector)
        case 3 => _root_.shaded.scalapb.descriptors.PRepeated(annotations.iterator.map(_root_.shaded.scalapb.descriptors.PString).toVector)
        case 4 => `type`.map(_root_.shaded.scalapb.descriptors.PString).getOrElse(_root_.shaded.scalapb.descriptors.PEmpty)
        case 5 => _root_.shaded.scalapb.descriptors.PRepeated(companionAnnotations.iterator.map(_root_.shaded.scalapb.descriptors.PString).toVector)
        case 6 => _root_.shaded.scalapb.descriptors.PRepeated(sealedOneofExtends.iterator.map(_root_.shaded.scalapb.descriptors.PString).toVector)
      }
    }
...
object MessageOptions extends scalapb.GeneratedMessageCompanion[scalapb.options.MessageOptions] {
  ...
  implicit def messageReads: _root_.shaded.scalapb.descriptors.Reads[scalapb.options.MessageOptions] = _root_.shaded.scalapb.descriptors.Reads{
  ...
  def scalaDescriptor: _root_.shaded.scalapb.descriptors.Descriptor = ScalapbProto.scalaDescriptor.messages(1)
  ...
  implicit class MessageOptionsLens[UpperPB](_l: _root_.shaded.scalapb.lenses.Lens[UpperPB, scalapb.options.MessageOptions]) extends _root_.shaded.scalapb.lenses.ObjectLens[UpperPB, scalapb.options.MessageOptions](_l) {
    def `extends`: _root_.shaded.scalapb.lenses.Lens[UpperPB, _root_.scala.Seq[_root_.scala.Predef.String]] = field(_.`extends`)((c_, f_) => c_.copy(`extends` = f_))
    def companionExtends: _root_.shaded.scalapb.lenses.Lens[UpperPB, _root_.scala.Seq[_root_.scala.Predef.String]] = field(_.companionExtends)((c_, f_) => c_.copy(companionExtends = f_))
    ...
    def companionAnnotations: _root_.shaded.scalapb.lenses.Lens[UpperPB, _root_.scala.Seq[_root_.scala.Predef.String]] = field(_.companionAnnotations)((c_, f_) => c_.copy(companionAnnotations = f_))
    def sealedOneofExtends: _root_.shaded.scalapb.lenses.Lens[UpperPB, _root_.scala.Seq[_root_.scala.Predef.String]] = field(_.sealedOneofExtends)((c_, f_) => c_.copy(sealedOneofExtends = f_))
  }
  ...
  ): _root_.shaded.scalapb.options.MessageOptions = _root_.shaded.scalapb.options.MessageOptions(
    `extends`,
    companionExtends,
    annotations,
    `type`,
