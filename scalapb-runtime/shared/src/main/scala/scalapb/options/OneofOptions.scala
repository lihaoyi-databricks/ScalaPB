...
object OneofOptions extends scalapb.GeneratedMessageCompanion[scalapb.options.OneofOptions] {
  ...
  implicit def messageReads: _root_.shaded.scalapb.descriptors.Reads[scalapb.options.OneofOptions] = _root_.shaded.scalapb.descriptors.Reads{
  ...
  def scalaDescriptor: _root_.shaded.scalapb.descriptors.Descriptor = ScalapbProto.scalaDescriptor.messages(5)
  ...
  implicit class OneofOptionsLens[UpperPB](_l: _root_.shaded.scalapb.lenses.Lens[UpperPB, scalapb.options.OneofOptions]) extends _root_.shaded.scalapb.lenses.ObjectLens[UpperPB, scalapb.options.OneofOptions](_l) {
  ...
  ): _root_.shaded.scalapb.options.OneofOptions = _root_.shaded.scalapb.options.OneofOptions(
    `extends`
  )
}
