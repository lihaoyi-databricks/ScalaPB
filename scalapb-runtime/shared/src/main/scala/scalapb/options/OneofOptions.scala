...
final case class OneofOptions(
    ...
    def mergeFrom(`_input__`: _root_.grpc_shaded.com.google.protobuf.CodedInputStream): scalapb.options.OneofOptions = {
...
object OneofOptions extends scalapb.GeneratedMessageCompanion[scalapb.options.OneofOptions] {
  ...
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.grpc_shaded.com.google.protobuf.Descriptors.FieldDescriptor, _root_.scala.Any]): scalapb.options.OneofOptions = {
  ...
  implicit def messageReads: _root_.grpc_shaded.scalapb.descriptors.Reads[scalapb.options.OneofOptions] = _root_.grpc_shaded.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.grpc_shaded.com.google.protobuf.Descriptors.Descriptor = ScalapbProto.javaDescriptor.getMessageTypes.get(5)
  def scalaDescriptor: _root_.grpc_shaded.scalapb.descriptors.Descriptor = ScalapbProto.scalaDescriptor.messages(5)
  ...
  implicit class OneofOptionsLens[UpperPB](_l: _root_.grpc_shaded.scalapb.lenses.Lens[UpperPB, scalapb.options.OneofOptions]) extends _root_.grpc_shaded.scalapb.lenses.ObjectLens[UpperPB, scalapb.options.OneofOptions](_l) {
  ...
  ): _root_.grpc_shaded.scalapb.options.OneofOptions = _root_.grpc_shaded.scalapb.options.OneofOptions(
    `extends`
  )
}
