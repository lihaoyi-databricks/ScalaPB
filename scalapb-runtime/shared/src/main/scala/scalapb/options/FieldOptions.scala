...
final case class FieldOptions(
    ...
    private[this] def __computeSerializedValue(): _root_.scala.Int = {
      ...
      if (noBox.isDefined) {
        ...
        __size += _root_.grpc_shaded.com.google.protobuf.CodedOutputStream.computeBoolSize(30, __value)
      };
      __size
    }
    ...
    def mergeFrom(`_input__`: _root_.grpc_shaded.com.google.protobuf.CodedInputStream): scalapb.options.FieldOptions = {
    ...
    def getField(__field: _root_.grpc_shaded.scalapb.descriptors.FieldDescriptor): _root_.grpc_shaded.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        case 1 => `type`.map(_root_.grpc_shaded.scalapb.descriptors.PString).getOrElse(_root_.grpc_shaded.scalapb.descriptors.PEmpty)
        case 2 => scalaName.map(_root_.grpc_shaded.scalapb.descriptors.PString).getOrElse(_root_.grpc_shaded.scalapb.descriptors.PEmpty)
        case 3 => collectionType.map(_root_.grpc_shaded.scalapb.descriptors.PString).getOrElse(_root_.grpc_shaded.scalapb.descriptors.PEmpty)
        case 4 => keyType.map(_root_.grpc_shaded.scalapb.descriptors.PString).getOrElse(_root_.grpc_shaded.scalapb.descriptors.PEmpty)
        case 5 => valueType.map(_root_.grpc_shaded.scalapb.descriptors.PString).getOrElse(_root_.grpc_shaded.scalapb.descriptors.PEmpty)
        case 6 => _root_.grpc_shaded.scalapb.descriptors.PRepeated(annotations.iterator.map(_root_.grpc_shaded.scalapb.descriptors.PString).toVector)
        case 7 => mapType.map(_root_.grpc_shaded.scalapb.descriptors.PString).getOrElse(_root_.grpc_shaded.scalapb.descriptors.PEmpty)
        case 30 => noBox.map(_root_.grpc_shaded.scalapb.descriptors.PBoolean).getOrElse(_root_.grpc_shaded.scalapb.descriptors.PEmpty)
      }
    }
...
object FieldOptions extends scalapb.GeneratedMessageCompanion[scalapb.options.FieldOptions] {
  ...
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.grpc_shaded.com.google.protobuf.Descriptors.FieldDescriptor, _root_.scala.Any]): scalapb.options.FieldOptions = {
  ...
  implicit def messageReads: _root_.grpc_shaded.scalapb.descriptors.Reads[scalapb.options.FieldOptions] = _root_.grpc_shaded.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.grpc_shaded.com.google.protobuf.Descriptors.Descriptor = ScalapbProto.javaDescriptor.getMessageTypes.get(2)
  def scalaDescriptor: _root_.grpc_shaded.scalapb.descriptors.Descriptor = ScalapbProto.scalaDescriptor.messages(2)
  ...
  implicit class FieldOptionsLens[UpperPB](_l: _root_.grpc_shaded.scalapb.lenses.Lens[UpperPB, scalapb.options.FieldOptions]) extends _root_.grpc_shaded.scalapb.lenses.ObjectLens[UpperPB, scalapb.options.FieldOptions](_l) {
    def `type`: _root_.grpc_shaded.scalapb.lenses.Lens[UpperPB, _root_.scala.Predef.String] = field(_.getType)((c_, f_) => c_.copy(`type` = Option(f_)))
    def optionalType: _root_.grpc_shaded.scalapb.lenses.Lens[UpperPB, _root_.scala.Option[_root_.scala.Predef.String]] = field(_.`type`)((c_, f_) => c_.copy(`type` = f_))
    def scalaName: _root_.grpc_shaded.scalapb.lenses.Lens[UpperPB, _root_.scala.Predef.String] = field(_.getScalaName)((c_, f_) => c_.copy(scalaName = Option(f_)))
    def optionalScalaName: _root_.grpc_shaded.scalapb.lenses.Lens[UpperPB, _root_.scala.Option[_root_.scala.Predef.String]] = field(_.scalaName)((c_, f_) => c_.copy(scalaName = f_))
    ...
    def keyType: _root_.grpc_shaded.scalapb.lenses.Lens[UpperPB, _root_.scala.Predef.String] = field(_.getKeyType)((c_, f_) => c_.copy(keyType = Option(f_)))
    def optionalKeyType: _root_.grpc_shaded.scalapb.lenses.Lens[UpperPB, _root_.scala.Option[_root_.scala.Predef.String]] = field(_.keyType)((c_, f_) => c_.copy(keyType = f_))
    def valueType: _root_.grpc_shaded.scalapb.lenses.Lens[UpperPB, _root_.scala.Predef.String] = field(_.getValueType)((c_, f_) => c_.copy(valueType = Option(f_)))
    def optionalValueType: _root_.grpc_shaded.scalapb.lenses.Lens[UpperPB, _root_.scala.Option[_root_.scala.Predef.String]] = field(_.valueType)((c_, f_) => c_.copy(valueType = f_))
    def annotations: _root_.grpc_shaded.scalapb.lenses.Lens[UpperPB, _root_.scala.Seq[_root_.scala.Predef.String]] = field(_.annotations)((c_, f_) => c_.copy(annotations = f_))
    ...
    def noBox: _root_.grpc_shaded.scalapb.lenses.Lens[UpperPB, _root_.scala.Boolean] = field(_.getNoBox)((c_, f_) => c_.copy(noBox = Option(f_)))
    def optionalNoBox: _root_.grpc_shaded.scalapb.lenses.Lens[UpperPB, _root_.scala.Option[_root_.scala.Boolean]] = field(_.noBox)((c_, f_) => c_.copy(noBox = f_))
  }
  ...
  ): _root_.grpc_shaded.scalapb.options.FieldOptions = _root_.grpc_shaded.scalapb.options.FieldOptions(
    `type`,
    scalaName,
    collectionType,
    keyType,
