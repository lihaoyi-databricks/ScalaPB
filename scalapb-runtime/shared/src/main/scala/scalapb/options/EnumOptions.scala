...
final case class EnumOptions(
    ...
    def getField(__field: _root_.shaded.scalapb.descriptors.FieldDescriptor): _root_.shaded.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        ...
        case 3 => `type`.map(_root_.shaded.scalapb.descriptors.PString).getOrElse(_root_.shaded.scalapb.descriptors.PEmpty)
      }
    }
...
object EnumOptions extends scalapb.GeneratedMessageCompanion[scalapb.options.EnumOptions] {
  ...
  implicit def messageReads: _root_.shaded.scalapb.descriptors.Reads[scalapb.options.EnumOptions] = _root_.shaded.scalapb.descriptors.Reads{
  ...
  def scalaDescriptor: _root_.shaded.scalapb.descriptors.Descriptor = ScalapbProto.scalaDescriptor.messages(3)
  ...
  implicit class EnumOptionsLens[UpperPB](_l: _root_.shaded.scalapb.lenses.Lens[UpperPB, scalapb.options.EnumOptions]) extends _root_.shaded.scalapb.lenses.ObjectLens[UpperPB, scalapb.options.EnumOptions](_l) {
  ...
  ): _root_.shaded.scalapb.options.EnumOptions = _root_.shaded.scalapb.options.EnumOptions(
    `extends`,
    companionExtends,
    `type`
  )
