...
final case class EnumOptions(
    ...
    def mergeFrom(`_input__`: _root_.grpc_shaded.com.google.protobuf.CodedInputStream): scalapb.options.EnumOptions = {
    ...
    def getField(__field: _root_.grpc_shaded.scalapb.descriptors.FieldDescriptor): _root_.grpc_shaded.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        ...
        case 3 => `type`.map(_root_.grpc_shaded.scalapb.descriptors.PString).getOrElse(_root_.grpc_shaded.scalapb.descriptors.PEmpty)
      }
    }
...
object EnumOptions extends scalapb.GeneratedMessageCompanion[scalapb.options.EnumOptions] {
  ...
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.grpc_shaded.com.google.protobuf.Descriptors.FieldDescriptor, _root_.scala.Any]): scalapb.options.EnumOptions = {
  ...
  implicit def messageReads: _root_.grpc_shaded.scalapb.descriptors.Reads[scalapb.options.EnumOptions] = _root_.grpc_shaded.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.grpc_shaded.com.google.protobuf.Descriptors.Descriptor = ScalapbProto.javaDescriptor.getMessageTypes.get(3)
  def scalaDescriptor: _root_.grpc_shaded.scalapb.descriptors.Descriptor = ScalapbProto.scalaDescriptor.messages(3)
  ...
  implicit class EnumOptionsLens[UpperPB](_l: _root_.grpc_shaded.scalapb.lenses.Lens[UpperPB, scalapb.options.EnumOptions]) extends _root_.grpc_shaded.scalapb.lenses.ObjectLens[UpperPB, scalapb.options.EnumOptions](_l) {
  ...
  ): _root_.grpc_shaded.scalapb.options.EnumOptions = _root_.grpc_shaded.scalapb.options.EnumOptions(
    `extends`,
    companionExtends,
    `type`
  )
