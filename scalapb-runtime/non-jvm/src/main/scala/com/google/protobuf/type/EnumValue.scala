...
object EnumValue extends shaded.scalapb.GeneratedMessageCompanion[com.google.protobuf.`type`.EnumValue] {
  implicit def messageCompanion: shaded.scalapb.GeneratedMessageCompanion[com.google.protobuf.`type`.EnumValue] = this
