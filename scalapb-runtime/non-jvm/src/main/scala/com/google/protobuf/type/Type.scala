...
object Type extends shaded.scalapb.GeneratedMessageCompanion[com.google.protobuf.`type`.Type] {
  implicit def messageCompanion: shaded.scalapb.GeneratedMessageCompanion[com.google.protobuf.`type`.Type] = this
