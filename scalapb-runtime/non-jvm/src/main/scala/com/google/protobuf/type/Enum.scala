...
object Enum extends shaded.scalapb.GeneratedMessageCompanion[com.google.protobuf.`type`.Enum] {
  implicit def messageCompanion: shaded.scalapb.GeneratedMessageCompanion[com.google.protobuf.`type`.Enum] = this
