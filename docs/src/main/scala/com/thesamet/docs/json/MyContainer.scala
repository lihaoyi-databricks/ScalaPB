...
final case class MyContainer(
    ...
    def mergeFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.thesamet.docs.json.MyContainer = {
      ...
      while (!_done__) {
        ...
        _tag__ match {
          case 0 => _done__ = true
          case 10 =>
            __myAny = Option(_root_.shaded.scalapb.LiteParser.readMessage(_input__, __myAny.getOrElse(com.google.protobuf.any.Any.defaultInstance)))
    ...
    def getField(__field: _root_.shaded.scalapb.descriptors.FieldDescriptor): _root_.shaded.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        case 1 => myAny.map(_.toPMessage).getOrElse(_root_.shaded.scalapb.descriptors.PEmpty)
      }
    }
...
object MyContainer extends scalapb.GeneratedMessageCompanion[com.thesamet.docs.json.MyContainer] {
  ...
  implicit def messageReads: _root_.shaded.scalapb.descriptors.Reads[com.thesamet.docs.json.MyContainer] = _root_.shaded.scalapb.descriptors.Reads{
  ...
  def scalaDescriptor: _root_.shaded.scalapb.descriptors.Descriptor = JsonProto.scalaDescriptor.messages(1)
  ...
  implicit class MyContainerLens[UpperPB](_l: _root_.shaded.scalapb.lenses.Lens[UpperPB, com.thesamet.docs.json.MyContainer]) extends _root_.shaded.scalapb.lenses.ObjectLens[UpperPB, com.thesamet.docs.json.MyContainer](_l) {
    def myAny: _root_.shaded.scalapb.lenses.Lens[UpperPB, com.google.protobuf.any.Any] = field(_.getMyAny)((c_, f_) => c_.copy(myAny = Option(f_)))
    def optionalMyAny: _root_.shaded.scalapb.lenses.Lens[UpperPB, _root_.scala.Option[com.google.protobuf.any.Any]] = field(_.myAny)((c_, f_) => c_.copy(myAny = f_))
  }
