...
final case class MyMessage(
    ...
    def getField(__field: _root_.shaded.scalapb.descriptors.FieldDescriptor): _root_.shaded.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        case 1 => _root_.shaded.scalapb.descriptors.PInt(x)
      }
    }
...
object MyMessage extends scalapb.GeneratedMessageCompanion[com.thesamet.docs.json.MyMessage] {
  ...
  implicit def messageReads: _root_.shaded.scalapb.descriptors.Reads[com.thesamet.docs.json.MyMessage] = _root_.shaded.scalapb.descriptors.Reads{
  ...
  def scalaDescriptor: _root_.shaded.scalapb.descriptors.Descriptor = JsonProto.scalaDescriptor.messages(0)
  ...
  implicit class MyMessageLens[UpperPB](_l: _root_.shaded.scalapb.lenses.Lens[UpperPB, com.thesamet.docs.json.MyMessage]) extends _root_.shaded.scalapb.lenses.ObjectLens[UpperPB, com.thesamet.docs.json.MyMessage](_l) {
    def x: _root_.shaded.scalapb.lenses.Lens[UpperPB, _root_.scala.Int] = field(_.x)((c_, f_) => c_.copy(x = f_))
  }
