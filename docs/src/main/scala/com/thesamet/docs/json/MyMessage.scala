...
final case class MyMessage(
    ...
    def mergeFrom(`_input__`: _root_.grpc_shaded.com.google.protobuf.CodedInputStream): com.thesamet.docs.json.MyMessage = {
      var __x = this.x
      var _done__ = false
      while (!_done__) {
    ...
    def getField(__field: _root_.grpc_shaded.scalapb.descriptors.FieldDescriptor): _root_.grpc_shaded.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        case 1 => _root_.grpc_shaded.scalapb.descriptors.PInt(x)
      }
    }
...
object MyMessage extends scalapb.GeneratedMessageCompanion[com.thesamet.docs.json.MyMessage] {
  ...
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.grpc_shaded.com.google.protobuf.Descriptors.FieldDescriptor, _root_.scala.Any]): com.thesamet.docs.json.MyMessage = {
  ...
  implicit def messageReads: _root_.grpc_shaded.scalapb.descriptors.Reads[com.thesamet.docs.json.MyMessage] = _root_.grpc_shaded.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.grpc_shaded.com.google.protobuf.Descriptors.Descriptor = JsonProto.javaDescriptor.getMessageTypes.get(0)
  def scalaDescriptor: _root_.grpc_shaded.scalapb.descriptors.Descriptor = JsonProto.scalaDescriptor.messages(0)
  ...
  implicit class MyMessageLens[UpperPB](_l: _root_.grpc_shaded.scalapb.lenses.Lens[UpperPB, com.thesamet.docs.json.MyMessage]) extends _root_.grpc_shaded.scalapb.lenses.ObjectLens[UpperPB, com.thesamet.docs.json.MyMessage](_l) {
    def x: _root_.grpc_shaded.scalapb.lenses.Lens[UpperPB, _root_.scala.Int] = field(_.x)((c_, f_) => c_.copy(x = f_))
  }
